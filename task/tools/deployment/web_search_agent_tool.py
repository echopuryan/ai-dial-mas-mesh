...
class WebSearchAgentTool(BaseAgentTool):
    ...
    def description(self) -> str:
        return "Tool for performing web searches using a web search agent. Can execute queries to retrieve information from the web and return relevant results. Useful for tasks that require up-to-date information or data that is not available in the agent's knowledge base."
